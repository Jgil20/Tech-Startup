...
/*
|--------------------------------------------------------------------------
	MULTISTEP FORM NEXT BUTTON SHOW/HIDE MAINTAIN
|--------------------------------------------------------------------------
*/
	...
	$(function() {  
		...
		$("input[name='opsys']").on("click", function() {
			...
			if( opsys && reqsevice ) {
				$(".quoteForm-step-1").css("display", "block");
			}
			else {
				$(".quoteForm-step-1").css("display", "none");
			}
			
        });					
		$( "#reqsevice" ).on("click", function() {
		...
		$( "#probudget" ).on("click", function() {
			
			var probudget = $("#probudget").val();
			var priority = $('input[name=priority]:checked').val();
			
			if( probudget && priority ) {
				$(".quoteForm-step-2").css("display", "block");
			}
			else {
				$(".quoteForm-step-2").css("display", "none");
			}
		...
		$( "#fname" ).keypress(function() {
			...
			if( fname.length > 0 && fname && lname.length > 0 && lname && gender && address.length > 0 && address && email.length > 5 && email && phone.length > 4 && phone ) {
				$(".quoteForm-step-3").css("display", "block");
			}
			else {
				$(".quoteForm-step-3").css("display", "none");
			}
		...
		$( "#requirementdetails" ).keypress(function() {
			
			var requirementdetails = $("#requirementdetails").val();
			var preferedcontact = $('input[name=preferedcontact]:checked').val();
			
			if ($('#aggre').is(":checked") && requirementdetails.length > 0 && requirementdetails && preferedcontact ) {
				$(".quoteForm-step-4").css("display", "block");
			}
			else {
				$(".quoteForm-step-4").css("display", "none");
			}
			
		});		
		$("input[name='preferedcontact']").on("click", function() {
