    ...
    <header class="header-area2 style-2 two">
        ...
        <div class="main-menu">
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item-has-children">
                    <a href="#" class="drop-down">Projects</a><i class="bi bi-plus dropdown-icon"></i>
                    <ul class="sub-menu">
                ...
                <form class="mobile-menu-form">
                    <div class="hotline pt-30">
                        ...
                        <div class="hotline-info">
                            ...
                            <h1><a href="tel:12389285567">1-238-938-5567</a></h1>
                        </div>
                    </div>
                    <div class="email pt-20 d-flex align-items-center">
                        ...
                        <div class="email-info">
                            <span>Email Now</span>
                            <h6><a href="mailto:example@gmail.com">Jgil20@me.com</a></h6>
                        </div>
                    </div>
                </form>
        ...
        <div class="nav-right d-flex jsutify-content-end align-items-center">
            <div class="header-contact d-xl-block d-none">
                ...
                <h6><a href="Tel:29658728617">1-238-938-5567</a></h6>
            </div>
            <div class="header-btn d-sm-flex d-none">
                <a href="https://arzugil.com/Cloud%20Technology%20Computing/index.html">View Resume</a>
            </div>
